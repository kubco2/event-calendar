...
public class UserManagerImplTest {
    ...
    public void createCorrectUser() throws Exception {
        User usr1 = userTemplate("Jakub", "kubco", "mypass");
    ...
    public void deleteUser() throws Exception {
        User usr = userTemplate("User name 1","nick1","pass1");
        userManager.createUser(usr);
    ...
    public void selectUserById() throws Exception {
        User usr1 = userTemplate("User name 1","nick1","pass1");
        User usr2 = userTemplate("User name 2","nick2","pass2");
        userManager.createUser(usr1);
    ...
    private User userTemplate(String name, String nick, String pass) {
        User user = new User();
        user.setName(name);
        user.setNick(nick);
